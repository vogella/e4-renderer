...
public class ExtensionAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExtensionSwitch<Adapter> modelSwitch =
		new ExtensionSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMyPart(MyPart object) {
				return createMyPartAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link extension.MyMap <em>My Map</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link extension.MyPart <em>My Part</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see extension.MyPart
	 * @generated
	 */
	public Adapter createMyPartAdapter() {
		return null;
	}

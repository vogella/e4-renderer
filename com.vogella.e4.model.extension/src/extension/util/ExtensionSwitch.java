...
public class ExtensionSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExtensionPackage.MY_OWN_PART: {
				MyOwnPart myOwnPart = (MyOwnPart)theEObject;
				T1 result = caseMyOwnPart(myOwnPart);
				if (result == null) result = casePart(myOwnPart);
				if (result == null) result = casePartSashContainerElement(myOwnPart);
				if (result == null) result = caseStackElement(myOwnPart);
				if (result == null) result = caseContribution(myOwnPart);
				if (result == null) result = caseContext(myOwnPart);
				if (result == null) result = caseUILabel(myOwnPart);
				if (result == null) result = caseHandlerContainer(myOwnPart);
				if (result == null) result = caseDirtyable(myOwnPart);
				if (result == null) result = caseBindings(myOwnPart);
				if (result == null) result = caseWindowElement(myOwnPart);
				if (result == null) result = caseUIElement(myOwnPart);
				if (result == null) result = caseApplicationElement(myOwnPart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionPackage.MY_OWN_PART_STACK: {
				MyOwnPartStack myOwnPartStack = (MyOwnPartStack)theEObject;
				T1 result = caseMyOwnPartStack(myOwnPartStack);
				if (result == null) result = casePartStack(myOwnPartStack);
				if (result == null) result = caseGenericStack(myOwnPartStack);
				if (result == null) result = casePartSashContainerElement(myOwnPartStack);
				if (result == null) result = caseWindowElement(myOwnPartStack);
				if (result == null) result = caseElementContainer(myOwnPartStack);
				if (result == null) result = caseUIElement(myOwnPartStack);
				if (result == null) result = caseApplicationElement(myOwnPartStack);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>My Own Part</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>My Own Part</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseMyOwnPart(MyOwnPart object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>My Own Part Stack</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>My Own Part Stack</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseMyOwnPartStack(MyOwnPartStack object) {
		return null;
	}
